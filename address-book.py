...
def add_contact():
    ...
    if not is_file_empty:
        list_contacts = address_book_file.read()
        print(type(list_contacts))
    else:
        list_contacts = []
    try:
        contact = str(get_contact_info_from_user())
        address_book_file = open("address_book_file.txt", "w")
...
print("Enter 'a' to add, 'b' to display, 'd' to delete, 'm' to modify, 's' to search and 'q' to quit")
while True:
